  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(color: Colors.grey[200]!, width: 1.3),
      ),
      ...
      child: ListTile(
        ...
        trailing: GetStorage().read('id_toko') == null
            ? Text(
                'Pilih Gerai',
                style: GoogleFonts.montserrat(fontSize: 12, color: textTheme),
              )
            : Icon(Icons.arrow_forward_ios, color: textTheme, size: 15),
      ),
    );
  }
}
